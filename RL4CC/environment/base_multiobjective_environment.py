...
class BaseMultiObjectiveEnvironment(gym.Env):
  """
  ...
  def __init__(self, env_config: dict):
    ...
    # define reward space
    self.define_reward_space()
    # reset
    self.reset(seed=seed)
  
  def load_configuration(self, env_config: dict) -> int:
    """
  ...
  def define_reward_space(self):
    """
    Define the environment reward space
    """
