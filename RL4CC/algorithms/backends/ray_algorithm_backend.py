...
class RayAlgorithmBackend(AlgorithmBackend):
  """
  RLlib-based implementation of the RL4CC algorithm backend.
  """
  def __init__(
      self,
      ...
      logger: Logger = Logger(name = "RL4CC-RayAlgorithmBackend")
    ):
    self.logger = logger
